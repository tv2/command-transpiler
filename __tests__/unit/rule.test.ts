...
test('fill', () => {
 const rule = new Rule('#{ number: num }', '#{ num }', 'num | equal 2')
 expect(rule.fill({ num: 1 })?.result).toEqual('1')
 expect(rule.fill({ num: 2 })?.result).toEqual('2')
 expect(rule.fill({ num: 3 })?.result).toEqual('3')
})

test('transpile', () => {
 const rule = new Rule('#{ number: num }', '#{ num }', 'num | equal 2')
 expect(rule.transpile('1')).toEqual(null)
 expect(rule.transpile('2')?.result).toEqual('2')
 expect(rule.transpile('3')).toEqual(null)
})

test('no condition', () => {
 const rule = new Rule('#{ number: num }', '#{ num }')
 expect(rule.transpile('1')?.result).toEqual('1')
 expect(rule.transpile('2')?.result).toEqual('2')
 expect(rule.transpile('3')?.result).toEqual('3')
})
...
test('even', () => {
  ...
  expect(rule.transpile('1')).toEqual(null)
  expect(rule.transpile('2')?.result).toEqual('even')
  expect(rule.transpile('3')).toEqual(null)
  expect(rule.transpile('4')?.result).toEqual('even')
  expect(rule.transpile('5')).toEqual(null)
  expect(rule.transpile('6')?.result).toEqual('even')
  expect(rule.transpile('7')).toEqual(null)
  expect(rule.transpile('8')?.result).toEqual('even')
  expect(rule.transpile('9')).toEqual(null)
  expect(rule.transpile('10')?.result).toEqual('even')
  expect(rule.transpile('11')).toEqual(null)
  expect(rule.transpile('12')?.result).toEqual('even')
})

test('odd', () => {
  const rule = new Rule('#{ number: num }', 'odd', 'num | mod 2 | equal 1')
  expect(rule.transpile('1')?.result).toEqual('odd')
  expect(rule.transpile('2')).toEqual(null)
  expect(rule.transpile('3')?.result).toEqual('odd')
  expect(rule.transpile('4')).toEqual(null)
  expect(rule.transpile('5')?.result).toEqual('odd')
  expect(rule.transpile('6')).toEqual(null)
  expect(rule.transpile('7')?.result).toEqual('odd')
  expect(rule.transpile('8')).toEqual(null)
  expect(rule.transpile('9')?.result).toEqual('odd')
  expect(rule.transpile('10')).toEqual(null)
  expect(rule.transpile('11')?.result).toEqual('odd')
